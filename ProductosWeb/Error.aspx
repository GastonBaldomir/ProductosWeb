...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center mt-5">
        ...
        <asp:Image CssClass="candado" ImageUrl="https://cdn-icons-png.flaticon.com/512/5220/5220262.png" runat="server" />
    ...
    <%else
        { %>
            <% if (!ConexionDb.Seguridad.esAdmin(Session["usuario"])&&(ConexionDb.Seguridad.sesionActiva(Session["usuario"])))
                { %>
            <div class="text-center mt-5">
            ...
            <%else
                { %>
                <div>   
                    <h1>Se detectó algun error, disculpe las molestias ocasionadas.</h1>
                   <asp:Image CssClass="candado" ImageUrl="https://cdn-icons-png.flaticon.com/512/5220/5220262.png" runat="server" />
                </div>
