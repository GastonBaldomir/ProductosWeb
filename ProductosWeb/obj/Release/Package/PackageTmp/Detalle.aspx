...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row m-3 mt-5">
        <div class="col-4 m-3 p-3 bg-light border border-gray rounded mb-2">
            <div class="mb-4 ">
                <asp:Label Text="Nombre:" ID="lblNombreDetalle" runat="server" class="form-label fs-5" />
                <asp:TextBox CssClass="form-control mt-2" runat="server" ID="txbNombreDetalle" Enabled="false" />
            </div>
            <div class="mb-4">
                <asp:Label Text="Precio:" ID="idPrecioDetalle" runat="server" class="form-label fs-5"  />
                <asp:TextBox CssClass="form-control mt-2" runat="server" ID="txbPrecioDetalle" Enabled="false" />
            </div>
            <div class="mb-4">
                ...
                <asp:TextBox CssClass="form-control mt-2 text-secondary" runat="server" ID="txbDescrDetalle" TextMode="MultiLine" Enabled="false"/>
            </div>
            <div class="mb-4">
        ...
        <div class="col-4 m-4 ">
            <asp:UpdatePanel ID="updatePanel3" runat="server">
                <ContentTemplate>
                    <div class="mb-3">                         
                            <asp:Image ImageUrl="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ28WA2ZQREgEZ1jva2HNK6hzzNLXtnkxGhG2eCg1bAuw&s" onerror="this.onerror=null; this.src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ28WA2ZQREgEZ1jva2HNK6hzzNLXtnkxGhG2eCg1bAuw&s'" runat="server" ID="urlImgDetalle" style="Height:350px; Width: 400px;" />                    
